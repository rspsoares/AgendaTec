...
function SelecionarLinhaGridInscricao() {
    ...
    if (selectedItem != null) {
        ...
        ShowModalAlert('Nenhuma Conta foi selecionada.');
...
function SaveUserCreation() {
    ...
    if (form.valid()) {
        ...
        ShShowModalAlertAjustes os campos marcados antes de Salvar!');
    }
}
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.sucesso) {
                    ...
                    ShoShowModalAlertsult.msg);
                }
            }
        });
    }
    else {
        ShoShowModalAlertjustes os campos marcados antes de Salvar!');
    }
}