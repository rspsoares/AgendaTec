    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.length > 0) {
                ...
                ShowModalAlert("Erro ao obter os Status dos Protocolos de Devolução");
                return;
            }          
        }
    });
    ...
    $.ajax({
        ...
        success: function (envio) {
            if (envio == "") {
                ...
                ShowModalSucess("E-Mail enviado com Sucesso!");
            }
            else {
                SShowModalAlertenvio + "!");
            }
        }
    });
}
...
function Cancelar() {
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == "") {
                ShowModalSucess("Protocolo cancelado com Sucesso!");
                LoadDsGrid(null);
            }
            else {
                ShShowModalAlertesult + "!");
            }
        }
    });
}
...
function Excluir() {
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result == "") {
                ShowModalSucess("Cancelamento por Prazo realizado com sucesso!");
                LoadDsGrid(null);
            }
            else {
                ShoShowModalAlertsult + "!");
            }
        }
    });
}
