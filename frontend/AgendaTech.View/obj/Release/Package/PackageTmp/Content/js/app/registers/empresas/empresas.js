...
function EditarEmpresa(e, locked) {
    ...
    $.ajax({
        ...
        error: function (result) {
            ShowModalAlert('Estes dados não podem ser exibidos!');
        }
    });
...
function SaveEmpresaCreation() {
    ...
    if (form.valid()) {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result != 0) {
                    ...
                    ShowModalSucess("Matriz incluida com sucesso!");
                    $("#grid").html("");
                    LoadDsGrid();
                }
                else 
                {
                    SShowModalAlertresult);
                }
            },
            error: function (result) {
                $("#loading-page").hide();
        ...
        SShowModalAlert'A Razão Social e CNPJ são obrigatórios para o cadastro da Matriz');
    }
}
    ...
    if (form.valid()) {
        ...
        $.ajax({
            ...
            success: function (result) {
                $("#loading-page").hide();
                $('#modalEditarEmpresa').modal('hide');
                ShowModalSucess("Matriz atualizada com sucesso!");
                $("#grid").html("");
                LoadDsGrid();
            },
            error: function (result) {
        ...
        ShoShowModalAlert Razão Social e CNPJ são obrigatórios para o cadastro da Matriz');
    }
}
    ...
    $("#loading-page").show();
        ...
        $.ajax({
            ...
            success: function (result) {
                $("#loading-page").hide();
                $('#modalEditarEmpresa').modal('hide');
                ShowModalSucess("Matriz excluida com sucesso!");
                $("#grid").html("");
                LoadDsGrid();
            },
            error: function (result) {
...
function BuscarDadosGrid(grid, msgNenhumRegistro) {
    ...
    */
    ...
    if (grid.dataSource.total() == 0) {
        ShowMShowModalAlertenhumRegistro);
    }
}