...
namespace AgendaTech.Business.Contracts
{
    ...
    {
        List<ScheduleDTO> GetGrid(int idCustomer, int idProfessional, int idService, int idConsumer, DateTime? dateFrom, DateTime? dateTo, bool? bonus, out string errorMessage);
